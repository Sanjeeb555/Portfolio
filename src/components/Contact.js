            ...
            <div class="container">
                <div class="row">
                    <div class="contact-left">
                        ...
                        <p><i class="fa-sharp fa-solid fa-square-envelope"></i> sanjeeb4223@gmail.com</p>
                        <p><i class="fa-solid fa-square-phone"></i>+91-9040038268</p>
                        <div class="social-icon">
                            <a href="https://www.linkedin.com/in/sanjeebdev/" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
                            <a href="https://twitter.com/" target="_blank"><i class="fa-brands fa-square-x-twitter"></i></a>
                            <a href="https://www.facebook.com/" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                            <a href="https://www.instagram.com/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                        <a href={require("../images/SanjeebDashResume.pdf")} download class="btn btn2">Download Resume/CV</a>
                    </div>

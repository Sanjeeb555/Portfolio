                ...
                <div className="work-list">
                    ...
                    <div className="work">
                        ...
                        <div className="layer">
                            ...
                            <a href="https://leetcode.com/sanjeeb555/" target="_blank"><i className="fa-sharp fa-solid fa-arrow-up-right-from-square"></i></a>
                        </div>
                    </div>
                    <div className="work">
                        ...
                        <div className="layer">
                            ...
                            <a href="https://www.geeksforgeeks.org/user/sanjeebdash/" target="_blank"><i className="fa-sharp fa-solid fa-arrow-up-right-from-square"></i></a>
                        </div>
                    </div>
                </div>
